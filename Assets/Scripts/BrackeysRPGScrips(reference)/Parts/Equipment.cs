...
[CreateAssetMenu(fileName = "New Item", menuName = "Part")]
...
public enum EquipmentSlot { Head, LeftArm, RightArm, LeftLeg, RightLeg, 
	Torso, Engine, Generator, Booster, ShoulderWeaponRight, ShoulderWeaponLeft, HandWeaponRight,HandWeaponLeft}
