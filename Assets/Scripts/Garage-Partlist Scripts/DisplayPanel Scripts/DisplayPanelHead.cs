...
public class DisplayPanelHead : MonoBehaviour
{
  public Head part;
  ...
  public GameObject field6Number;
  ...
  public void UpdateText()
  {
    ...
    field4Number.GetComponent<TMPro.TextMeshProUGUI>().text = part.sensorAbility.ToString();
    field5Number.GetComponent<TMPro.TextMeshProUGUI>().text = part.ecmCounter.ToString();
    field6Number.GetComponent<TMPro.TextMeshProUGUI>().text = part.coordination.ToString();
  }
}
